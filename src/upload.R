...
upload_tex(get_clic_descriptive_stats_tex(cleaned_valid), save_dir, "clic_descriptive.tex", server_url)
upload_tex(get_clic_tukey_tex(cleaned_valid), save_dir, "clic_tukey.tex", server_url)
